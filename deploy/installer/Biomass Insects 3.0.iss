...
AppId={{59AB8DB8-D5B3-4E16-B0F4-A14FA5CA0B59}
...
Source: {#BuildDir}\Landis.Extension.BiomassInsects-v3.dll; DestDir: {#ExtDir}; Flags: replacesameversion
Source: {#BuildDir}\Landis.Extension.BiomassInsects-v3.pdb; DestDir: {#ExtDir}; Flags: replacesameversion
